...
const Contact = () => {
  return (
    <div className="md:px-10 px-7 my-10" id="contact">
      ...
      {/* social icons */}
      <div className="flex ">
        <a href="https://www.linkedin.com/in/sahil-aryan-singh-362612212" target="_blank" rel="noreferrer">
          <img src={facebook} alt="" />
        </a>
        <a className="ml-4" href="https://github.com/0xSahilx" target="_blank" rel="noreferrer">
        <img src={instagram} alt="" />
        </a>
        <a className="ml-4" href="mailto:sahilaryan9211@gmail.com" target="_blank" rel="noreferrer">
